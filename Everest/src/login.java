...
public class login extends javax.swing.JFrame {
    ...
    User u = new User();
    static Connection conn = DBConnection.establishConnection();
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        try {
            ...
            String pass = h.toHash(String.valueOf(PasswordField.getText()));
            String username = "";
            String password = "";
            Privilege = "";
            String query = "select * from user where Username =? ";
            // create the mysql insert preparedstatement
            PreparedStatement preparedStatement = doConnection.prepareStatement(query);
            ...
            if (user.equals(username) && pass.equals(password)) {
                ...
                if ("Admin".equals(Privilege)) {
                    ...
                    mFA.setVisible(true);
                } else if ("Normal User".equals(Privilege)) {
                    this.setVisible(false);
                    mFS.setVisible(true);
                }
            } else {
            ...
            try {
                ...
                if (user.equals(username) && pass.equals(password)) {
                    ...
                    if (privilege.equals("Admin")) {
                        this.setVisible(false);
                        mFA.setVisible(true);
                    } else if (privilege.equals("Normal User")) {
                        this.setVisible(false);
                        mFS.setVisible(true);
                    }
                } else {
