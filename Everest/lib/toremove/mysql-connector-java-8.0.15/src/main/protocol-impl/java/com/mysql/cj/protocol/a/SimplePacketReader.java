...
/**
 * Simple implementation of {@link MessageReader} which handles the receiving of
 * logical MySQL packets from the provided socket input stream. Multi-packets
 * are handled outside of this reader.
 */
